      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex overflow-x-auto gap-3 sm:gap-4 md:flex-wrap md:gap-4 lg:justify-between lg:gap-0 scrollbar-hide">
          {Array.from({ length: cardCount }).map((_, index) => (
            ...
            >
              <div
                className="w-[180px] h-[230px] sm:w-[120px] sm:h-[205px] md:w-[220px] md:h-[280px] lg:w-[246px] lg:h-[310px] bg-gradient-to-br from-gray-200 to-gray-300 mb-4 overflow-hidden relative shadow-lg transition-shadow duration-300 rounded-[15px] sm:rounded-[30px]"
              >
